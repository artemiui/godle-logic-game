...
{#if isOpen}
  ...
  >
    <div
      class="w-full max-w-md bg-white dark:bg-neutral-950 border border-neutral-900 dark:border-neutral-200 text-neutral-900 dark:text-neutral-100 p-6 sm:p-8 space-y-6 shadow-2xl relative"
      role="dialog"
      aria-modal="true"
    >
      <!-- Modal Header -->
